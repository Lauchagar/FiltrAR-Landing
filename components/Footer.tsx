...
export default function Footer() {
  return (
    <footer className="border-t border-surface-700/40 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 items-start mb-10">
          ...
          <div className="flex flex-col items-start sm:items-end gap-3">
            <p className="text-stone-500 text-xs uppercase tracking-widest font-semibold mb-1">Mayoristas</p>
            <a
              href={WA_LINK}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[#25D366]/10 hover:bg-[#25D366]/20 border border-[#25D366]/25 text-[#25D366] text-sm font-semibold px-4 py-2 rounded-lg transition-all"
            >
